export const DATA = {
  ...
  experience: [
    ...
    },
    {
      ...
      place: 'Remote',
      bullets: [
        'Owned the web payment flow for in-app currency end to end, from React frontend through NestJS backend to Kafka event publishing. Millions of dollars processed. Zero critical payment bugs shipped.',
        ...
        'Built the web storefront, auction bidding system, and direct-purchase flows from scratch. These became the primary revenue surface for hundreds of thousands of transactions.',
