...
// Self-hosted from public/fonts/, generated by scripts/fetch-fonts.mjs. The
// same-origin preloads still need crossorigin: fonts are always fetched in
// CORS mode, and without it the browser discards the preload and refetches.
const FONTS = `<link rel="preload" href="/fonts/ibm-plex-sans-normal-var-latin.woff2" as="font" type="font/woff2" crossorigin />
